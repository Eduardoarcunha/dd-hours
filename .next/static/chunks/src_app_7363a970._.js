(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_7363a970._.js", {
...
function Home() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setResult(null);
        try {
            const record = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$csvFetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCsvDataById"])(inputId);
            setResult(record);
        } catch (err) {
            console.error(err);
...
//# sourceMappingURL=src_app_7363a970._.js.map